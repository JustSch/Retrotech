<nav class="navbar navbar-light bg-light" hidden>
    <div class="form-inline">
      <input class="form-control mr-sm-2 searchbox" name="q1" id="q"1 type="text" aria-label="Search">
      <button class="btn searchB btn-outline-success  my-2 my-sm-0 " type="submit" onclick="rsearch()" ><i class="fas fa-search" aria-hidden="true"></i></button>
